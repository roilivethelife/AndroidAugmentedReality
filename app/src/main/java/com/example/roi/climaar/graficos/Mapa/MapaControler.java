...
import com.example.roi.climaar.graficos.figuras.Texto.GLText;
import com.example.roi.climaar.graficos.figuras.Texto.GLTextDrawer;
import com.example.roi.climaar.graficos.figuras.Obj;
...
public class MapaControler {
    ...
    public static Mapa createLoadDefaultMap(){
        ...
        */
        ...
        glTextDrawer.load("Roboto-Regular.ttf",100,0,0);
